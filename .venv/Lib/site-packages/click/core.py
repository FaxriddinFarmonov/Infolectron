...
class Context:
    ...
    def set_parameter_source(self, name: str, source: ParameterSource) -> None:
        ...
        :param source: A member of :class:`~click.sc.ParameterSource`.
        """
    ...
    def get_parameter_source(self, name: str) -> ParameterSource | None:
        ...
        will be :attr:`~click.sc.ParameterSource.DEFAULT` only if the
...
class Parameter:
    ...
    .. versionchanged:: 8.2
        Adding duplicate parameter names to a :class:`~click.sc.Command` will
